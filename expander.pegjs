...
Grammar
  = __ initializer:(Initializer __)? rules:(Line __)+ {
      return {
        type:        "grammar",
...
Line = OpDefinition / RemoveOpDefinition / AtomDefinition / SpecialNumberDefinition / ReservedWordDefinition / Rule

OpDefinition 
  = leftAssoc:(__ "left" __ "associative" __ {return true})? "binary" __ "operator" __ name:StringLiteral __ "precedence" __ precedence:FloatLiteral realName:(__ "as" __ realName:StringLiteral {return realName})? EOS {return {type:"operator",kind:"binary",name:name,precedence:precedence,realName:realName,leftAssoc:leftAssoc}}
  / kind:("prefix"/"postfix") __ "operator" __ name:StringLiteral realName:(__ "as" __ realName:StringLiteral {return realName})? EOS {return {type:"operator",kind:kind,name:name,realName:realName}}
RemoveOpDefinition
  = "remove" __ "operator" __ name:StringLiteral EOS {return {type:"remove-op",name:name}}
AtomDefinition = "atom" before:(__ "before" __ before:IdentifierName {return before})? __ rule:Rule EOS {return {type:"atom", rule:rule, before: before}}
SpecialNumberDefinition = "special" __ "number" __ name:StringLiteral __ "=" __ code:CodeBlock EOS {return {type:'special number',name:name,code:code}}
ReservedWordDefinition = "reserved" __ "word" __ name:StringLiteral EOS {return {type:'reserved word',name:name}}
...
FloatLiteral
 = int:DecimalDigit+ rest:(DecimalPoint digits:DecimalDigit+ {return digits.join('')})? {return parseFloat(int.join('')+'.'+rest)}
